...
public class DevDigicodeButtonMessage {
	private final int buttonID, x, y, z;

	public DevDigicodeButtonMessage(FriendlyByteBuf buffer) {
	...
	public DevDigicodeButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(DevDigicodeButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(DevDigicodeButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		HashMap guistate = DevDigicodeMenu.guistate;
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		KrusaderSecurityMod.addNetworkMessage(DevDigicodeButtonMessage.class, DevDigicodeButtonMessage::buffer, DevDigicodeButtonMessage::new, DevDigicodeButtonMessage::handler);
	}
}
